...
import { HeartIcon } from "../product/favorite/heartIcon";
  ...
  return (
    <>
     ...
     rounded-2xl  hover:border border-indigo-600  bg-black "
            >
              <img
                className="rounded-2xl  h-full w-full scale-100  hover:scale-110 transition-all  duration-500  transform ease-in-out object-cover"
                src={i.product_image}
              />
              ...
              >
                <a href="#">
                  <p className="text-xs md:text-xs">{i.product_card_name}</p>
                </a>
                <a href="#">
                  <Button
