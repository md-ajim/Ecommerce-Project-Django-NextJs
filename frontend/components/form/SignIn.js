...
export default function SignIn() {
  ...
  return (
    <div className="md:min-h-screen  dark:bg-black flex items-center justify-center px-4 md:px-0">
      <div className=" dark:bg-gray-900 dark:text-white bg-white mt-20  md-mt-0 lg:mt-0 mb-4 p-8 rounded-lg shadow-lg w-full max-w-sm">
        ...
        <form method="POST" onSubmit={onSubmit}>
              ...
              <div className="absolute inset-y-0 right-0 pr-3 flex items-center">
                ...
                >
                  {showPassword ? (
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      className="w-5 h-5 dark:text-blue-200 text-gray-700"
                      fill="none"
                      viewBox="0 0 24 24"
                      stroke="currentColor"
                      strokeWidth={2}
         ...
         { error && "Invalid username or password" }
          ...
          <button
            type="submit"
            className="w-full bg-black flex items-center justify-center text-white py-3 rounded-lg  focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
          >
        ...
        <div className="mt-6 text-center">
          <p className="text-sm  dark:text-white text-gray-600">
            ...
            <Link href="/form/signup" className="text-blue-500 hover:underline">
              Sign up
            </Link>
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 gap-3">
          <button
            ...
            className="w-full inline-flex justify-center py-2 px-4 border border-gray-300 rounded-lg shadow-sm bg-white text-gray-700 font-medium hover:bg-gray-50"
          >
            <img
